...
The template design will automatically change when the screen of the user is small. The template for small screens is illustrated in figure \ref{fig:templateDesignSmall}.
\begin{figure}[h]
    \centering
    \includegraphics[width=.6\textwidth]{templateDesign/templateDesignSmall}
    \caption{Template design of small screens.}
    \label{fig:templateDesignSmall}
\end{figure}
